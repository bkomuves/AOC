...
main = do
  arr <- load "input11"
  let final1 = steps    arr
  putStrLn $ "part 1: " ++ (show $ sum $ map occupied_cnt $ elems final1)
  let final2 = steps_v2 arr
  putStrLn $ "part 2: " ++ (show $ sum $ map occupied_cnt $ elems final2)
